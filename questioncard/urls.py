...
from .views import QuestionCardListView, QuestionCardCreateView, QuestionCardUpdateView, QuestionCardApiView, QuestionCardSwapOrderApiView
...
urlpatterns = [
    ...
    path('rest', QuestionCardApiView.as_view(), name='question_card_api_view'),
